...
struct matrix * make_bezier() {
  struct matrix *ret;
  ret = new_matrix(4,4);
  ret->m[0][0] = -1; ret->m[0][1] = 3; ret->m[0][2] = -3; ret->m[0][3] = 1;
  ret->m[1][0] = 3; ret->m[1][1] =-6; ret->m[1][2] = 3; ret->m[1][3] = 0;
  ret->m[2][0] = -3; ret->m[2][1] = 3; ret->m[2][2] = 0; ret->m[2][3] = 0;
  ret->m[3][0] = 1; ret->m[3][1] = 0; ret->m[3][2] = 0; ret->m[3][3] = 0;
  ret->lastcol = 4;
...
struct matrix * make_hermite() {
  struct matrix *ret;
  ret = new_matrix(4,4);
  ret->m[0][0]=2; ret->m[0][1]=-2; ret->m[0][2]=1; ret->m[0][3]=1;
  ret->m[1][0]=-3; ret->m[1][1]=3; ret->m[1][2]=-2; ret->m[1][3]=-1;
