...
void parse_file ( char * filename, 
  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
	...
	tmp = make_rotZ( theta );
      ...
      scanf(" %lf %lf %lf %lf %lf %lf %lf %lf ",&xvals[0],&yvals[0],&xvals[1],&yvals[1],&xvals[2],&yvals[2],&xvals[3],&yvals[3]);
      add_curve(edges,xvals[0],yvals[0],xvals[1],yvals[1],xvals[2],yvals[2],xvals[3],yvals[3],0.001,0);
    }
      ...
      scanf(" %lf %lf %lf %lf ",&xvals[0],&yvals[0],&zvals[0],&zvals[1]);
      add_circle(edges,xvals[0],yvals[0],zvals[0],zvals[1],0.001);
    }
